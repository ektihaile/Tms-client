...
function signalMethod(processingFn, config) {
    ...
    const signalMethodFn = (input, config) => {
        if (isReactiveComputation(input)) {
            ...
            }, { ...(ngDevMode ? { debugName: "watcher" } : /* istanbul ignore next */ {}), injector: instanceInjector });
...
function executeWatcher(stateSource, stateWatcher) {
    untracked(() => {
...
function signalState(initialState) {
    ...
    const signalState = computed(() => stateKeys.reduce((state, key) => ({ ...state, [key]: stateSource[key]() }), {}), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "signalState" }] : /* istanbul ignore next */ []));
...
function signalStore(...args) {
    ...
    class SignalStore {
        ...
        /** @nocollapse */ static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.0", ngImport: i0, type: SignalStore, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
        /** @nocollapse */ static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.0", ngImport: i0, type: SignalStore, providedIn: config.providedIn || null });
    }
    i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.0", ngImport: i0, type: SignalStore, decorators: [{
                type: Injectable,
